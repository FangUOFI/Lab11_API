...
base_theft_2021 <- paste0(base_URL, "$limit=20000","&$where=date between '2021-01-01T00:00:00.000' and '2021-06-30T23:59:59.000'","&primary_type='THEFT'", "&$select=date, primary_type, x_coordinate, y_coordinate")
